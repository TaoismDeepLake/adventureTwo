...
import com.deeplake.adven2.util.IDLNBT;
...
import static com.deeplake.adven2.util.NBTStrDef.IDLNBTDef.*;
...
public class IDLNBTUtil {
    ...
    public static NBTTagCompound getPlyrIdlTagSafe(EntityPlayer player) {
        ...
        NBTTagCompound idl_data = getTagSafe(data, Idealland.MODID);

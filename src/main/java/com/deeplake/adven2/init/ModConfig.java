...
public class ModConfig {
    ...
    @Config.LangKey("configgui.adven2.category.Menu0.GeneralConf")
...
//        @Config.LangKey("adven2.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "adven2.msg.welcome";
    }

    @Config.LangKey("configgui.adven2.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.adven2.category.Menu0.SpawnConf")

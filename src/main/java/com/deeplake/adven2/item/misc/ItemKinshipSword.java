...
import com.deeplake.adven2.item.IGuaEnhance;
import com.deeplake.adven2.item.ItemSwordBase;
import com.deeplake.adven2.util.CommonDef;
import com.deeplake.adven2.util.IDLGeneral;
...
//    public com.deeplake.adven2.item.skills.martial.BuffTuple GetWaterBuff(ItemStack stack)
//    {
//        int water = GetGuaEnhance(stack, 2);
//        return new com.deeplake.adven2.item.skills.martial.BuffTuple(water / 4, TICK_PER_SECOND * water * 2);
//    }
//
//    public com.deeplake.adven2.item.skills.martial.BuffTuple GetMountainBuff(ItemStack stack)
//    {
//        int gua = GetGuaEnhance(stack, 4);
//        return new com.deeplake.adven2.item.skills.martial.BuffTuple(gua / 4, TICK_PER_SECOND * gua * 2);
//    }
//

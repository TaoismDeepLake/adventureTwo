...
import com.deeplake.adven2.entity.creatures.EntityModUnit;
import com.deeplake.adven2.item.ItemBase;
import com.deeplake.adven2.util.CommonFunctions;
import com.deeplake.adven2.util.EntityUtil;
import com.deeplake.adven2.util.NBTStrDef.IDLNBTUtil;
...
import static com.deeplake.adven2.util.NBTStrDef.IDLNBTDef.MARK_TOTAL_COUNT;
    ...
    public boolean itemInteractionForEntity(ItemStack stack, EntityPlayer playerIn, EntityLivingBase target, EnumHand handIn) {
        if (target instanceof EntityModUnit)
        {
            ...
            if (legalTarget.is_mechanic)
            {
                ...
                {
                    CommonFunctions.SafeSendMsgToPlayer(playerIn, "adven2.msg.upgrade_module.req_lv", String.valueOf(requireLv));
                    return false;
                }
                ...
                if (!playerIn.world.isRemote)
                {
                    ...
                    if (success)
                    {
                        ...
                        CommonFunctions.SafeSendMsgToPlayer(playerIn, "adven2.msg.upgrade_module.ok", valueBefore, valueAfter);

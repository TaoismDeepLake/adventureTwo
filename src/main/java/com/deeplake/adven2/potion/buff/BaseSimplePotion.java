package com.deeplake.adven2.potion.buff;
...
public class BaseSimplePotion extends Potion {
    protected static final ResourceLocation resource = new ResourceLocation("adven2","textures/misc/potions.png");
...
//    }
    ...
    public BaseSimplePotion(boolean isBadEffectIn, int liquidColorIn, String name, int icon) {
        ...
        setPotionName("adven2.potion." + name);
        iconIndex = icon;
    }
